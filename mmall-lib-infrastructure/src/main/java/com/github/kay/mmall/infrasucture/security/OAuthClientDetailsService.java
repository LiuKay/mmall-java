...
public class OAuthClientDetailsService implements ClientDetailsService {
    ...
    public OAuthClientDetailsService(PasswordEncoder passwordEncoder) {
     ...
     * 刷新令牌Endpoint示例：
     * /oauth/token?grant_type=refresh_token & refresh_token=#REFRESH_TOKEN# & client_id=#CLIENT_ID# & client_secret=#CLIENT_SECRET#
     */
    @PostConstruct
