...
public class VerificationCodeSecurityConfiguration extends
                                                   SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {

    private final Filter verificationCodeFilter;

    public VerificationCodeSecurityConfiguration(
            @Autowired @Qualifier("verificationCodeFilter") Filter verificationCodeFilter) {
